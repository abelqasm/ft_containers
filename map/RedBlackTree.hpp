...
/*   Updated: 2023/02/21 17:07:35 by abelqasm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    //------------------------------------------------------------------------------------------------
        //constructors
        RedBlackTree(const node_allocatore &alloc = node_allocatore(),  const value_compare &comp =  value_compare(key_compare()), const equal_key &equal = equal_key()) : _alloc(alloc), _comp(comp), _equalKey(equal), _treeSize(0)
        {
